    ...
    graph.AddPass<ChromaticAberrationData>(
        ...
        [this, input, output](RenderGraphBuilder& builder, ChromaticAberrationData& data)
        {
            ...
            if (inputDesc)
            {
                ...
                viewDesc.debugName = "ChromaticAberrationInputSRV";
            ...
            if (outputDesc)
            {
                ...
                viewDesc.debugName = "ChromaticAberrationOutputRTV";
        ...
        [this](const ChromaticAberrationData& data, RenderGraphPassContext& context)
        {
            if (!m_pipelineCache)
            {
            ...
            RHIPipeline* pipeline = m_pipelineCache->GetChromaticAberrationPipeline(data.outputFormat);
