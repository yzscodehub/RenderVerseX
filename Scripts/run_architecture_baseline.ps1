...
$baselineRegex = @(
    ...
    "FeatureBoundaryValidation\.(WaterComponentPublicHeaderDoesNotExposeRenderOrRHI|WaterComponentBuildsRenderSnapshotWithoutGPUHandles|TerrainComponentPublicHeaderDoesNotExposeRenderOrRHI|TerrainComponentBuildsRenderSnapshotWithoutGPUHandles|RenderFeatureSceneBridgeCollectsFeatureSnapshotsThroughProviderContract)",
