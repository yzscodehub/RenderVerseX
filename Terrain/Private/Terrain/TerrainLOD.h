...
namespace RVX
{
    ...
    /**
     * @brief LOD mask value used when neighbor crack-prevention masks are unavailable
     */
    constexpr uint32 RVX_TERRAIN_LOD_MASK_UNGENERATED = 0;
    ...
    struct TerrainLODNode
    {
        ...
        uint32 lodMask;         ///< Neighbor LOD mask; RVX_TERRAIN_LOD_MASK_UNGENERATED when unavailable
    };
    ...
    public:
        ...
        /**
         * @brief Diagnostic for patch mesh GPU upload status
         */
        const std::string& GetPatchMeshDiagnostic() const { return m_patchMeshDiagnostic; }

        /**
         * @brief True when quadtree nodes use full terrain height bounds instead of sampled ranges
         */
        bool UsesConservativeHeightBounds() const { return m_usesConservativeHeightBounds; }

        /**
         * @brief Diagnostic for quadtree height-bound accuracy
         */
        const std::string& GetHeightBoundsDiagnostic() const { return m_heightBoundsDiagnostic; }

        /**
         * @brief Crack-prevention neighbor masks are not generated by the current fallback path
         */
        bool SupportsCrackPrevention() const { return false; }

        /**
         * @brief Diagnostic for crack-prevention mask support
         */
        const std::string& GetCrackPreventionDiagnostic() const { return m_crackPreventionDiagnostic; }
    ...
    private:
        ...
        std::string m_crackPreventionDiagnostic =
            "Terrain LOD crack-prevention masks are not generated; lodMask remains RVX_TERRAIN_LOD_MASK_UNGENERATED.";
