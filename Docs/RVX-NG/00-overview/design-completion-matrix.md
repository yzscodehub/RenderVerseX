...
- v1.1 的目标口径是“生产级框架底座 + 分级演进上限”：首期证明边界、契约、RenderGraph/RHI、Scene-to-Render、资源/Shader、诊断 artifact、测试门禁和工具化骨架，长期能力按 Proven / Advanced / Research 逐级兑现。
...
1. 对所有“可评审”模块做实施前一致性审查：接口边界、数据所有权、线程模型、测试门禁是否互相矛盾，并确认它们服务于 v1.1 的生产级框架底座。
